public class Spring extends PhysicsElement {
   ...
   public void attachEnd1 (Ball as) {  // note: we attach a spring to a ball, 
      ...
      if(b_end1==null && b_end2 == null){  //al spring se le puede agregar tanto una bola como un fixedhook
     	 b_end1 = as;   
       as.attachSpring(this);
      	 return;
      }
   ...
   public void attachEnd2 (FixedHook qw) {  // note: we attach a spring to a fixedHook, 
